...
var ClientFunctionBuilder = function () {
    ...
    ClientFunctionBuilder.prototype.getFunction = function getFunction() {
        ...
        var clientFn = function __$$clientFunction$$() {
            var testRun = builder.options.boundTestRun ? builder.options.boundTestRun.testRun : _testRunTracker2.default.resolveContextTestRun();
    ...
    ClientFunctionBuilder.prototype._validateOptions = function _validateOptions(options) {
        ...
        if (!(0, _lodash.isNil)(options.boundTestRun)) {
            ...
            if (!(options.boundTestRun.testRun instanceof _testRun2.default)) throw new _runtime.APIError(this.callsiteNames.instantiation, _message2.default.invalidClientFunctionTestRunBinding);
        }
