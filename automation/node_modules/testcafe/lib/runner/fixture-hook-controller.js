...
var FixtureHookController = function () {
    ...
    FixtureHookController.prototype._getFixtureMapItem = function _getFixtureMapItem(testRun) {
        return testRun.test.skip ? null : this.fixtureMap.get(testRun.test.fixture);
    };

    FixtureHookController.prototype.isTestRunBlocked = function isTestRunBlocked(testRun) {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            item = this._getFixtureMapItem(testRun);
                        ...
                        case 16:
                            ...
                            testRun.state = _state2.default.inFixtureBeforeHook;
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            testRun.state = _state2.default.inFixtureAfterHook;
