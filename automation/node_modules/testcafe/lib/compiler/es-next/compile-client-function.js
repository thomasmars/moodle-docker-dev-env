...
var ANONYMOUS_FN_RE = /^function\*?\s*\(/;
...
var ASYNC_TO_GENERATOR_OUTPUT_CODE = (0, _asyncToGenerator2.default)(_lodash.noop).toString().replace(/\n\s*/g, '');
...
function compileClientFunction(fnCode, dependencies, instantiationCallsiteName, compilationCallsiteName) {
    ...
    if (ANONYMOUS_FN_RE.test(fnCode)) fnCode = '(' + fnCode + ')';
