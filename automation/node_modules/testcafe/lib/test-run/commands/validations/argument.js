...
var PROTOCOL_RE = /^([\w-]+?)(?=\:)/;
var SUPPORTED_PROTOCOL_RE = /^https?/i;
...
function urlArgument(name, val) {
    ...
    if (protocol && !SUPPORTED_PROTOCOL_RE.test(protocol[0])) throw new _testRun.ActionUnsupportedUrlProtocolError(name, protocol[0]);
}
