...
var _debuggerMessage = require('../notifications/debugger-message');

var _debuggerMessage2 = _interopRequireDefault(_debuggerMessage);
...
ServiceMessages[_clientMessages2.default.showDebuggerMessage] = function (msg) {
    this.debugLog.driverMessage(msg);

    (0, _debuggerMessage2.default)(this.currentDriverTask.callsite, this.browserConnection.userAgent);
