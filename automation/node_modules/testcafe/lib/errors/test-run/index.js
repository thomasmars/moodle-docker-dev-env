...
var ActionStringArgumentError = exports.ActionStringArgumentError = function (_ActionArgumentErrorB) {
    (0, _inherits3.default)(ActionStringArgumentError, _ActionArgumentErrorB);

    function ActionStringArgumentError(argumentName, actualValue) {
        (0, _classCallCheck3.default)(this, ActionStringArgumentError);
        return (0, _possibleConstructorReturn3.default)(this, _ActionArgumentErrorB.call(this, _type2.default.actionStringArgumentError, argumentName, actualValue));
    }

    return ActionStringArgumentError;
}(ActionArgumentErrorBase);

var ActionIntegerArgumentError = exports.ActionIntegerArgumentError = function (_ActionArgumentErrorB2) {
    (0, _inherits3.default)(ActionIntegerArgumentError, _ActionArgumentErrorB2);

    function ActionIntegerArgumentError(argumentName, actualValue) {
        (0, _classCallCheck3.default)(this, ActionIntegerArgumentError);
        return (0, _possibleConstructorReturn3.default)(this, _ActionArgumentErrorB2.call(this, _type2.default.actionIntegerArgumentError, argumentName, actualValue));
    }

    return ActionIntegerArgumentError;
}(ActionArgumentErrorBase);

var ActionPositiveIntegerArgumentError = exports.ActionPositiveIntegerArgumentError = function (_ActionArgumentErrorB3) {
    (0, _inherits3.default)(ActionPositiveIntegerArgumentError, _ActionArgumentErrorB3);
    ...
    function ActionPositiveIntegerArgumentError(argumentName, actualValue) {
        ...
        return (0, _possibleConstructorReturn3.default)(this, _ActionArgumentErrorB3.call(this, _type2.default.actionPositiveIntegerArgumentError, argumentName, actualValue));
    }

    return ActionPositiveIntegerArgumentError;
}(ActionArgumentErrorBase);

var ActionStringOrStringArrayArgumentError = exports.ActionStringOrStringArrayArgumentError = function (_ActionArgumentErrorB4) {
    (0, _inherits3.default)(ActionStringOrStringArrayArgumentError, _ActionArgumentErrorB4);
    ...
    function ActionStringOrStringArrayArgumentError(argumentName, actualValue) {
        ...
        return (0, _possibleConstructorReturn3.default)(this, _ActionArgumentErrorB4.call(this, _type2.default.actionStringOrStringArrayArgumentError, argumentName, actualValue));
    }

    return ActionStringOrStringArrayArgumentError;
}(ActionArgumentErrorBase);

var ActionStringArrayElementError = exports.ActionStringArrayElementError = function (_ActionArgumentErrorB5) {
    (0, _inherits3.default)(ActionStringArrayElementError, _ActionArgumentErrorB5);
...
var ActionUnsupportedUrlProtocolError = exports.ActionUnsupportedUrlProtocolError = function (_TestRunErrorBase16) {
    (0, _inherits3.default)(ActionUnsupportedUrlProtocolError, _TestRunErrorBase16);

    function ActionUnsupportedUrlProtocolError(argumentName, protocol) {
        (0, _classCallCheck3.default)(this, ActionUnsupportedUrlProtocolError);
    ...
    return ActionUnsupportedUrlProtocolError;
}(TestRunErrorBase);
...
var ActionElementNotIframeError = exports.ActionElementNotIframeError = function (_TestRunErrorBase31) {
    (0, _inherits3.default)(ActionElementNotIframeError, _TestRunErrorBase31);

    function ActionElementNotIframeError() {
        (0, _classCallCheck3.default)(this, ActionElementNotIframeError);
        return (0, _possibleConstructorReturn3.default)(this, _TestRunErrorBase31.call(this, _type2.default.actionElementNotIframeError));
    }

    return ActionElementNotIframeError;
}(TestRunErrorBase);

var ActionIframeIsNotLoadedError = exports.ActionIframeIsNotLoadedError = function (_TestRunErrorBase32) {
    (0, _inherits3.default)(ActionIframeIsNotLoadedError, _TestRunErrorBase32);

    function ActionIframeIsNotLoadedError() {
        (0, _classCallCheck3.default)(this, ActionIframeIsNotLoadedError);
        return (0, _possibleConstructorReturn3.default)(this, _TestRunErrorBase32.call(this, _type2.default.actionIframeIsNotLoadedError));
    }

    return ActionIframeIsNotLoadedError;
}(TestRunErrorBase);

var CurrentIframeIsNotLoadedError = exports.CurrentIframeIsNotLoadedError = function (_TestRunErrorBase33) {
    (0, _inherits3.default)(CurrentIframeIsNotLoadedError, _TestRunErrorBase33);

    function CurrentIframeIsNotLoadedError() {
        (0, _classCallCheck3.default)(this, CurrentIframeIsNotLoadedError);
        return (0, _possibleConstructorReturn3.default)(this, _TestRunErrorBase33.call(this, _type2.default.currentIframeIsNotLoadedError));
    }

    return CurrentIframeIsNotLoadedError;
}(TestRunErrorBase);

var CurrentIframeNotFoundError = exports.CurrentIframeNotFoundError = function (_TestRunErrorBase34) {
    (0, _inherits3.default)(CurrentIframeNotFoundError, _TestRunErrorBase34);

    function CurrentIframeNotFoundError() {
        (0, _classCallCheck3.default)(this, CurrentIframeNotFoundError);
        return (0, _possibleConstructorReturn3.default)(this, _TestRunErrorBase34.call(this, _type2.default.currentIframeNotFoundError));
    }

    return CurrentIframeNotFoundError;
}(TestRunErrorBase);

var CurrentIframeIsInvisibleError = exports.CurrentIframeIsInvisibleError = function (_TestRunErrorBase35) {
    (0, _inherits3.default)(CurrentIframeIsInvisibleError, _TestRunErrorBase35);

    function CurrentIframeIsInvisibleError() {
        (0, _classCallCheck3.default)(this, CurrentIframeIsInvisibleError);
        return (0, _possibleConstructorReturn3.default)(this, _TestRunErrorBase35.call(this, _type2.default.currentIframeIsInvisibleError));
    }
...
var NativeDialogNotHandledError = exports.NativeDialogNotHandledError = function (_TestRunErrorBase36) {
    (0, _inherits3.default)(NativeDialogNotHandledError, _TestRunErrorBase36);
...
var UncaughtErrorInNativeDialogHandler = exports.UncaughtErrorInNativeDialogHandler = function (_TestRunErrorBase37) {
    (0, _inherits3.default)(UncaughtErrorInNativeDialogHandler, _TestRunErrorBase37);
...
var SetNativeDialogHandlerCodeWrongTypeError = exports.SetNativeDialogHandlerCodeWrongTypeError = function (_TestRunErrorBase38) {
    (0, _inherits3.default)(SetNativeDialogHandlerCodeWrongTypeError, _TestRunErrorBase38);
...
var WindowDimensionsOverflowError = exports.WindowDimensionsOverflowError = function (_TestRunErrorBase39) {
    (0, _inherits3.default)(WindowDimensionsOverflowError, _TestRunErrorBase39);
