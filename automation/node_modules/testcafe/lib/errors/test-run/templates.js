...
var _state = require('../../test-run/state');

var _state2 = _interopRequireDefault(_state);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var SUBTITLES = (_SUBTITLES = {}, _SUBTITLES[_state2.default.initial] = '', _SUBTITLES[_state2.default.inFixtureBeforeHook] = '<span class="subtitle">Error in fixture.before hook</span>\n', _SUBTITLES[_state2.default.inFixtureBeforeEachHook] = '<span class="subtitle">Error in fixture.beforeEach hook</span>\n', _SUBTITLES[_state2.default.inTestBeforeHook] = '<span class="subtitle">Error in test.before hook</span>\n', _SUBTITLES[_state2.default.inTest] = '', _SUBTITLES[_state2.default.inTestAfterHook] = '<span class="subtitle">Error in test.after hook</span>\n', _SUBTITLES[_state2.default.inFixtureAfterEachHook] = '<span class="subtitle">Error in fixture.afterEach hook</span>\n', _SUBTITLES[_state2.default.inFixtureAfterHook] = '<span class="subtitle">Error in fixture.after hook</span>\n', _SUBTITLES);

function markup(err, msgMarkup) {
    var opts = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

    msgMarkup = (0, _dedent2.default)('\n        ' + SUBTITLES[err.testRunState] + '<div class="message">' + (0, _dedent2.default)(msgMarkup) + '</div>\n\n        <strong>Browser:</strong> <span class="user-agent">' + err.userAgent + '</span>\n    ');
